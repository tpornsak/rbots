 ...
 */
#define X_COXA      76  // MM between front and back legs /2
#define Y_COXA      76  // MM between front/back legs /2

/* Legs */
#define L_COXA      52  // MM distance from coxa servo to femur servo
#define L_FEMUR     32 // MM distance from femur servo to tibia servo
#define L_TIBIA     44 // MM distance from tibia servo to foot
