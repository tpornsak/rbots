...
int mins[] = {239, 462, 401, 237, 516, 366, 229, 158, 413, 234, 186, 200};
int maxs[] = {793, 812, 863, 772, 852, 633, 781, 504, 862, 771, 552, 500};
...
void setupIK(){
  ...
  endpoints[RIGHT_FRONT].y = 74;
  endpoints[RIGHT_FRONT].z = 68;

  endpoints[RIGHT_REAR].x = -52;
  endpoints[RIGHT_REAR].y = 74;
  endpoints[RIGHT_REAR].z = 68;

  endpoints[LEFT_FRONT].x = 52;
  endpoints[LEFT_FRONT].y = -74;
  endpoints[LEFT_FRONT].z = 68;

  endpoints[LEFT_REAR].x = -52;
  endpoints[LEFT_REAR].y = -74;
  endpoints[LEFT_REAR].z = 68;
