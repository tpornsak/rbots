...
int mins[] = {232, 250, 441, 172, 174, 413, 238, 232, 173, 432, 416, 171};
int maxs[] = {785, 787, 848, 595, 587, 852, 786, 786, 597, 855, 853, 609};
...
void setupIK(){
  ...
  endpoints[RIGHT_FRONT].y = 84;
  endpoints[RIGHT_FRONT].z = 33;

  endpoints[RIGHT_REAR].x = -52;
  endpoints[RIGHT_REAR].y = 84;
  endpoints[RIGHT_REAR].z = 33;

  endpoints[LEFT_FRONT].x = 52;
  endpoints[LEFT_FRONT].y = -84;
  endpoints[LEFT_FRONT].z = 33;

  endpoints[LEFT_REAR].x = -52;
  endpoints[LEFT_REAR].y = -84;
  endpoints[LEFT_REAR].z = 33;

  liftHeight = 24; //Harkey chaned from 8 to 24 on 3_25/2012
  stepsInCycle = 1;
  step = 0;
}
